...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ SITE_URL }}/assets/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="{{ SITE_URL }}/assets/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{ SITE_URL }}/assets/favicon-16x16.png" />
