                ...
                <div class="flex justify-between p-2 m-2">
                    <?php if($page <= 1): ?>
                        <a class="items-end px-4 py-2 text-sm font-semibold text-center text-white border-2 border-white rounded-md shadow bg-emerald-600 hover:bg-emerald-800"
                            href="<?php echo e(SITE_URL); ?><?php echo e($data['category_link']); ?>2">Next Page</a>
                    <?php else: ?>
                        <a class="items-start px-4 py-2 text-sm font-semibold text-center text-white border-2 border-white rounded-md shadow bg-emerald-600 hover:bg-emerald-800"
                            href="<?php echo e(SITE_URL); ?><?php echo e($data['category_link']); ?><?php echo e($page - 1); ?>">Previous
                            Page</a>
                        <a class="items-end px-4 py-2 text-sm font-semibold text-center text-white border-2 border-white rounded-md shadow bg-emerald-600 hover:bg-emerald-800"
                            href="<?php echo e(SITE_URL); ?><?php echo e($data['category_link']); ?><?php echo e($page + 1); ?>">Next Page</a>
                    <?php endif; ?>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\AutoWall\views/theme/default/category.blade.php ENDPATH**/ ?>